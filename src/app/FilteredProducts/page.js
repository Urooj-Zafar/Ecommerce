...
function ProductsContent() {
  ...
  const addToCart = (product) => {
    ...
    if (colors.length > 0 && !selected.color) {
    ...
    const existingIndex = cart.findIndex(
      (item) =>
        ...
        item?.size === (selected.size || null) &&
        item?.color === (selected.color || null)
    );
  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-28 pb-12">
      <div className="max-w-[1400px] mx-auto px-3 sm:px-5">
        ...
        <div className="bg-white px-5 py-5 mb-4 border-b border-gray-200">
          <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">
            {categoryFilter ? "Products" : "All Products"}
          </h1>
        ...
        <button
          ...
          className="lg:hidden w-full bg-white border border-gray-200 py-3 mb-4 flex items-center justify-center gap-2 text-sm font-medium"
        >
        ...
        <div className="flex gap-5">
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="bg-white px-4 py-3 mb-4 flex items-center justify-between gap-3 shadow-sm flex-wrap">
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {discount > 0 && (
                          <span className="absolute top-2 left-2 bg-black text-white text-[10px] px-2 py-1 font-medium">
                            -{discount}%
                          </span>
                        )}
                      </div>
                      ...
                      <div className="p-3">
                            ...
                            <div className="flex flex-wrap gap-1">
                              {sizes.map((size) => (
                                <button
                                  ...
                                  className={`px-2 py-1 text-[10px] border transition ${
                                    selected.size === size
                        ...
                        <button
                          ...
                          className="w-full mt-3 py-2.5 bg-black text-white text-sm font-medium hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed transition"
                        >
                          {product?.stock <= 0
                            ? "Out of Stock"
                            : "Add to Cart"}
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white z-[90] rounded-t-2xl p-5 max-h-[80vh] overflow-y-auto">
            ...
            <div className="flex gap-3 mt-8">
              ...
              <button
                type="button"
                onClick={resetFilters}
                className="flex-1 py-3 border border-black text-black text-sm hover:bg-black hover:text-white transition"
              >
                Reset
              </button>
              ...
              <button
                ...
                className="flex-1 py-3 bg-black text-white text-sm hover:bg-gray-800 transition"
              >
                Apply
              </button>
